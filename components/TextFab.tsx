...
export function TextFab() {
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-50 inline-flex items-center gap-2 rounded-full bg-bolt px-5 py-3.5 font-display text-sm font-bold text-ink shadow-[0_10px_30px_-6px_rgba(127,251,174,0.6)] transition-transform hover:scale-105 active:scale-95"
    >
